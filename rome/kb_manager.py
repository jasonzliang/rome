...
class ChromaKB:
    ...
    def __init__(self, config: Dict = None, agent=None):
        ...
        self.logger.info(f"ChromaKB initialized: collection={self.collection_name}, reranking={self.enable_reranking}")
    ...
    def shutdown(self):
        ...
        try:
            ...
            self.logger.info("ChromaKB shutdown completed")
        except Exception as e:
            self.logger.error(f"ChromaKB shutdown error: {e}")
